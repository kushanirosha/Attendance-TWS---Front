...
export const StatCardDetails = () => {
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      {/* ===== TOTAL ACTIVE NOW ===== */}
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl shadow-md border p-8 text-center">
        ...
        <div className="flex justify-center gap-10 mt-6 text-lg">
          <span className="text-green-600 font-semibold">
            Male: {stats.active.male}
          </span>
          <span className="text-pink-600 font-semibold">
            Female: {stats.active.female}
          </span>
        </div>
      </div>
      ...
      <div className="bg-red-50 rounded-2xl border-2 border-red-200 p-8">
        <h2 className="text-2xl font-bold text-red-800 text-center mb-6">
          Absent Current Shift ({stats.absent.total})
        </h2>
